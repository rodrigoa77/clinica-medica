...
public class VisualizacaoFuncionarioServlet extends HttpServlet {
    private int id;

    private FuncionarioService funcionarioService;

    public VisualizacaoFuncionarioServlet() {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/pages/admin/funcionarios/visualizacao-funcionario.jsp").forward(req, resp);
    }
